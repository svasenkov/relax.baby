...
Object(_modules_init_modals__WEBPACK_IMPORTED_MODULE_2__["initModals"])(); // Modules
// ---------------------------------

var reviewBtn = document.querySelector(".reviews a");
var mainContainer = document.querySelector("#content_main");
var messageContainer1 = document.querySelector(".message p");
var messageContainer2 = document.querySelector(".message span");
var buttonBlock = document.querySelector("form");

if (messageContainer1) {
  var type2 = function type2() {
    var typed2 = new Typed(messageContainer2, {
  ...
  var typed1 = new Typed(messageContainer1, {
  ...
  Object(_modules_init_swiper__WEBPACK_IMPORTED_MODULE_3__["initSwiper"])();
}
...
var timeout = window.price * 100;
setTimeout(function () {
  return $("#myAudioElement")[0].play();
}, 60 * 60000);

function geHide() {
  var element = document.getElementById("rew_act");
  var element2 = document.getElementById("content_main");
